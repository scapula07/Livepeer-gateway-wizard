...
export default function Terminate() {
  ...
  return (
    <div className="w-full h-full flex md:px-0 px-3 justify-center">
      <div className="flex flex-col md:w-[80%] w-full bg-white h-96 shadow ">
        <div className="flex flex-col w-full items-center justify-center  h-full space-y-4 px-8">
          ...
          <h5 className="font-bold text-sm">
            Confirm that you want to delete this Gateway by typing its
            Passphrase:
          </h5>
          <input
            required
          ...
          />
          <div className="flex items-center space-x-3 md:space-x-10 py-4 px-6">
            {isLoading ? (
            ...
            <button className="text-[#58815794] border border-[#58815794]  py-2 px-6">
              Cancel
            </button>
          </div>
        </div>
