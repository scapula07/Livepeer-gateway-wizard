    ...
    <>
      <div className="w-full flex flex-col space-y-5">
        ...
        <div className="flex items-center justify-end space-x-4 py-6">
          ...
          >
            {loader ? <ClipLoader size={12} /> : "Save changes"}
          </button>
        </div>
        <h5 className="text-sm bg-gray-200 py-4 px-4 rounded-sm w-full">
          Choose a transcoding profile that suits your content&apos;s needs.
          Adjust resolution, bitrate, and other settings for optimized video
          quality.
        </h5>
        <div className="flex flex-col py-8">
          ...
          <div className="flex items-center justify-end space-x-4 py-6">
            <button
              className="border-[#58815794] border text-[#58815794] py-2 px-4 text-sm font-bold"
              onClick={() => setTrigger(true)}
            >
              Add new profile
            </button>
            <button className="bg-[#58815794] py-2 px-4 text-sm font-bold">
              Import JSON
            </button>
          </div>
        </div>
      ...
      <Modal
        cname="w-full h-full flex justify-center items-center "
        trigger={trigger}
      >
...
const Profile = ({
  ...
  item: any;
  index: number;
  updateTemplate: (index: number, template: any) => void;
}) => {
    ...
    <div className="flex flex-col">
      <div className="flex w-full border-b border-t justify-between px-4 py-4 items-center">
        ...
        <div className="flex items-center space-x-6">
          ...
          {toggle ? (
            <FaToggleOn
              className="text-2xl text-[#58815794]"
    ...
    <div className="w-[45%] py-4 bg-white flex flex-col ">
      ...
      <div className="flex flex-col px-6">
        ...
        <div className="flex items-center py-2">
          <button
            className="bg-[#58815794] border  py-2 px-4 text-sm font-bold"
            onClick={() => setTrigger(true)}
          >
            Add Profile
          </button>
