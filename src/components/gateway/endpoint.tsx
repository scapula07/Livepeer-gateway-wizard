...
export default function Endpoint() {
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <p className="text-sm">
        Copy and paste the stream key into your streaming software. Use the RTMP
        ingest. The RTMP ingest is more common with OBS users.
      </p>

      <div className="flex flex-col py-5 space-y-2">
        <h5 className="font-semibold">RTMP ingest</h5>
        <div className="flex items-center space-x-4 ">
          <h5>rtmp://{gateway?.ip}:1935/mystream</h5>
