        ...
        <div className="w-full h-full  absolute z-10 top-0 ">
          ...
          <div className=" w-full bg-white flex-col flex items-center py-">
            ...
            <div className="flex flex-col space-y-4 items-center py-20">
              <h5 className="text-6xl font-bold text-center text-slate-800">
                Fuel the Future:
                <br></br>
                Be a Gateway Operator
              </h5>
              <button className="font-mono bg-green-400 w-[40%] py-2 font-semibold px-4 text-lg">
                Launch A Gateway
              </button>
            </div>
          </div>
        ...
        {[
          ...
          return (
            <div key={i} className="flex items-center space-x-10">
              <h5 className="text-4xl font-mono text-slate-800 font-semibold">
                {item?.label}
              </h5>
...
const imgSrc =
  "https://firebasestorage.googleapis.com/v0/b/reach-nft-auction.appspot.com/o/order%2Fglobe.gif?alt=media&token=9759fc81-5d0a-4786-b046-11de5f2af50d";
const videoSrc =
  "https://firebasestorage.googleapis.com/v0/b/reach-nft-auction.appspot.com/o/order%2Fvideo.mp4?alt=media&token=0e6abfd2-ed4d-4f25-a090-eeeff678ecd6";
