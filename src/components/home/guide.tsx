    ...
    <div className="w-full flex justify-center relative z-10 py-28 font-mono">
      <div className="flex flex-col space-y-10 items-center ">
        ...
        <div className="flex flex-col space-y-4">
          {[
            ...
            return (
              <div
                key={index}
                className="flex bg-white w-full shadow border py-6 px-6 space-x-4"
              >
                <h5 className="h-16 rounded-sm w-12 bg-green-300 flex items-center justify-center text-4xl font-bold">
                  {count}
                </h5>
        ...
        <div className="flex justify-center">
          <h5 className="w-3/5 text-center font-semibold">
            Check out this step-by-step tutorial or watch a demonstration on
