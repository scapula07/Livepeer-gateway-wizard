    ...
    <div className='w-full  flex px-10 py-20 font-mono space-x-10'>
           <div className='w-1/2 flex flex-col'>
                <div className='flex flex-col space-y-2'>
                    <h5 className='text-xl text-gray-700 font-semibold'>Why should you use this Wizard?</h5>
               ...
               <div className='flex flex-col space-y-4 py-8'>
                  {[
                    ...
                    return(
                        <div className='flex'>
                             <p className='text-sm'><span className='font-semibold  text-green-600'>{item?.label}</span> {item?.text}</p>
          ...
          <div className='w-1/2 flex flex-col'>
               ...
               <div className='flex flex-col space-y-4 py-8'>
                  {[
                    ...
                    return(
                        <div className='flex bg-white min-h-[60px] px-4 py-4 shadow'>
